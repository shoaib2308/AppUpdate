...
import static com.learningApp.appupdate.UpdateManagerConstant.FLEXIBLE;

public class UpdateManager2 implements LifecycleObserver {

    private static final String TAG = "InAppUpdateManager";

    private WeakReference<AppCompatActivity> mActivityWeakReference;

    private static UpdateManager2 instance;
    ...
    private UpdateManager2(AppCompatActivity activity) {
    ...
    public static UpdateManager2 Builder(AppCompatActivity activity) {
        if (instance == null) {
            instance = new UpdateManager2(activity);
        }
        Log.d(TAG, "1Instance created");
        return instance;
    }

    public UpdateManager2 mode(int mode) {
        String strMode = mode == FLEXIBLE ? "FLEXIBLE" : "IMMEDIATE";
        Log.d(TAG, "2Set update mode to : " + strMode);
        this.mode = mode;
        return this;
    }
    ...
    private void checkUpdate() {
        ...
        Log.d(TAG, "3Checking for updates");
        appUpdateInfoTask.addOnSuccessListener(new OnSuccessListener<AppUpdateInfo>() {
            ...
            public void onSuccess(AppUpdateInfo appUpdateInfo) {
                if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE
                    ...
                    // Request the update.
                    Log.d(TAG, "12Update available");
                    startUpdate(appUpdateInfo);
                } else {
                    Log.d(TAG, "13No Update available");
                }
            }
        });
    }
...
//    }
    ...
    private InstallStateUpdatedListener listener = new InstallStateUpdatedListener() {
        ...
        public void onStateUpdate(InstallState installState) {
            if (installState.installStatus() == InstallStatus.DOWNLOADED) {
                ...
                Log.d(TAG, "5An update has been downloaded");
                ...
                .addOnSuccessListener(new OnSuccessListener<AppUpdateInfo>() {
                    ...
                    public void onSuccess(AppUpdateInfo appUpdateInfo) {
                        ...
                        if (appUpdateInfo.installStatus() == InstallStatus.DOWNLOADED) {
                            Log.d(TAG, "6An update has been downloaded");
    ...
    private void unregisterListener() {
        if (appUpdateManager != null && listener != null) {
            ...
            Log.d(TAG, "10 Unregistered the install state listener");
        }
    }
